...
def whois(domain, api):
    ...
    def whoisxml(whois, domain):
        ...
        if config['api']['whoisxml']['api_key'] == '':
            ...
            # call the API
            api = config['api']['whoisxml']['url_whois'].format(config['api']['whoisxml']['api_key'], domain)
            r = requests.get(api)
    ...
    def whoxy(whois, domain):
        ...
        if config['api']['whoxy']['api_key'] == '':
            ...
            # call the API
            api = config['api']['whoxy']['url_whois'].format(config['api']['whoxy']['api_key'], domain)
            r = requests.get(api)
    ...
    # exceptions
        ...
        print('      │      ■ ' + Fore.RED + 'Error in loading the Whois API URL page.' + Style.RESET_ALL)
        print('      │      ■■ ERROR: ' + Fore.RED + str(e) + Style.RESET_ALL)        
    except requests.exceptions.ConnectionError as e:
        print('      │      ■ ' + Fore.RED + 'Error in establishing the connection to the Whois API URL.' + Style.RESET_ALL)
        print('      │      ■■ ERROR: ' + Fore.RED + str(e) + Style.RESET_ALL)  
    except requests.exceptions.Timeout as e:
        print('      │      ■ ' + Fore.RED + 'Timeout error.' + Style.RESET_ALL)
        print('      │      ■■ ERROR: ' + Fore.RED + str(e) + Style.RESET_ALL)  
    except requests.exceptions.RequestException as e:
        print('      │      ■ ' + Fore.RED + 'Error in reading the data from the Whois API URL.' + Style.RESET_ALL)
        print('      │      ■■ ERROR: ' + Fore.RED + str(e) + Style.RESET_ALL) 
    except requests.exceptions.TooManyRedirects as e:
        print('      │      ■ ' + Fore.RED + 'The provided Whois API URL does not seem correct.' + Style.RESET_ALL)
        print('      │      ■■ ERROR: ' + Fore.RED + str(e) + Style.RESET_ALL)
    except json.decoder.JSONDecodeError as e:
        print('      │      ■ ' + Fore.RED + 'Error in reading the JSON data retrieved from the Whois API call.' + Style.RESET_ALL)
        print('      │      ■■ ERROR: ' + Fore.RED + str(e) + Style.RESET_ALL)
